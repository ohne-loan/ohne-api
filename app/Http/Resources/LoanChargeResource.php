...
class LoanChargeResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            'id' => $this->id,
        	'time_arrear' => $this->time_arrear,
        	'bigger_time_arrear' => $this->bigger_time_arrear,
            'smaller_time_arrear' => $this->smaller_time_arrear,
            'frozen_balance' => money($this->frozen_balance)
		];
    }
