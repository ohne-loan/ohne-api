...
@section('content')
    ...
    <p style="text-align: justify;">
        Se o pagamento não for realizado nos <strong>próximos dias</strong>, seu nome e CPF poderão ser incluídos nos órgãos de proteção ao crédito, como o Boa Vista SCPC e o Serasa, por exemplo. 
        Aproveitamos para comunicar que o seu contrato foi cedido para a Rio São Francisco Cia Securitizadora de Créditos Financeiros, empresa parceira da Ohne e, caso seja necessário a inclusão nos órgãos de proteção ao crédito, esta será realizada pela nova credora cessionária do seu contrato.
    </p>
